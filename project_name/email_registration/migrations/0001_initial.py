...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailRegistrationProfile'
        db.create_table(u'email_registration_emailregistrationprofile', (
        ...
        db.send_create_signal(u'email_registration', ['EmailRegistrationProfile'])


    def backwards(self, orm):
        # Deleting model 'EmailRegistrationProfile'
        db.delete_table(u'email_registration_emailregistrationprofile')
    ...
    models = {
        ...
        u'email_registration.emailregistrationprofile': {
            'Meta': {'object_name': 'EmailRegistrationProfile', '_ormbases': [u'registration.RegistrationProfile']},
